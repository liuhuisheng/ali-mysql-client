...
exports.defaultOperator = function(config) {
  ...
  config.registerOperator("in", ({ field, value }) => ({
    sql: "?? in (?)",
    arg: [field, typeof value === "string" ? value.split(",") : value]
  }));
  ...
  config.registerOperator("isnull", ({ field, value }) => ({
    sql: "?? is null",
    arg: [field]
  }));

  config.registerOperator("isnotnull", ({ field, value }) => ({
    sql: "?? is not null",
    arg: [field]
  }));
